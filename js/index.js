...
const fromFieldsets = [formFieldsetType, formFieldsetDate, formFieldsetClient];
...
const showResultData = () => {
  ...
  `;
  formInfoDate.dataType = dateString;
};
...
const init = () => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch('https://bedecked-checker-cabbage.glitch.me/api/orders', {
        method: 'POST',
        headers: {
